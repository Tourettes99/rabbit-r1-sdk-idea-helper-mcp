...
description: >-
  charlax/professional-programming — curated learning resources for software engineers (README, master branch). Large link compendium; refresh from raw GitHub.
---

# Professional programming (charlax)

**Source URL:** https://raw.githubusercontent.com/charlax/professional-programming/master/README.md  
...
- This snapshot mirrors the upstream **README.md** on branch **`master`**.
- Do **not** replace with ad-hoc web search when this source is in the MCP index; refetch via `get_rabbit_sdk_knowledge_index` or the raw URL above.
- The document is a long resource list; prefer the **Table of Contents** in the snapshot for navigation.
- Append **Changelog (agent)** when you notice upstream README changes worth calling out.
...
- Initialized from rabbit-r1-sdk-idea-helper-mcp public library (full README snapshot).
