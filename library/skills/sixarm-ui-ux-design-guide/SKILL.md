---
name: sixarm-ui-ux-design-guide
description: >-
  SixArm UI/UX Design Guide index — glossary-style topics (UC, UX, IA, heuristics, a11y, testing). Source is raw GitHub index.md; edited by Joel Parker Henderson.
---

# UI/UX Design Guide (SixArm)

**Source URL:** https://raw.githubusercontent.com/SixArm/ui-ux-design-guide/main/index.md  
**Repository:** https://github.com/SixArm/ui-ux-design-guide

**Last sync:** 2026-04-29

## Rules

- Treat this file as the local snapshot for the **index** URL above; live content is on SixArm’s repo.
- Do **not** replace this with generic web-search summaries when the MCP index includes `registeredDocumentation` for this source.
- Topic links in the snapshot are **relative** (`topics/...`); resolve them in-repo on GitHub ([SixArm/ui-ux-design-guide](https://github.com/SixArm/ui-ux-design-guide)) — the `topics` path may point into the book’s content tree.
- Append **Changelog (agent)** when `index.md` changes materially (e.g. new sections).
...
- Added public library entry pointing at SixArm `index.md` (table of contents + links).
